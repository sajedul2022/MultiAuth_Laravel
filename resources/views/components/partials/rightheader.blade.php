                ...
                <div class="header-right d-flex align-items-center">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <div class="row">
                                <div class="col-md-12">
                                    <select class="form-control changeLang" name="">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                ...
                                <span
                                    class="badge badge-light bg-success badge-xs">{{ auth()->user()->unreadNotifications->count() }}
                                </span>
                            </a>
                                ...
                                <div id="DZ_W_Notification1" class="widget-media dz-scroll p-2">
                                    <ul class="timeline">
                                        ...
                                        @if (auth()->user()->unreadNotifications)
                                            <span>
                                                <a href="{{ route('mark-as-read') }}" class="btn btn-success btn-sm">Mark
                                                    All as Read</a>
                                            </span>
                                        @endif

                                        <hr> <span>Unread Notifications</span>
                                        ...
                                        <hr> <span>Read Notifications</span>
                                ...
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        <div class="header-media">
                                            <img class=" avatar-md" src="{{ asset('/master/images/user.png') }}"
                                                alt="user" width="30">
                                        </div>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" style="">
                                    <div class="card border-0 mb-0">
                                        <div class="card-header py-2">
                                            <div class="products">
                                                <img src="{{ asset('/master/images/user.png') }}"

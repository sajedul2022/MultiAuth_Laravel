...
<footer class="bg-white rounded shadow p-5 mb-4 mt-4">
    <div class="row">
        <div class="col-12 col-md-12 col-xl-12 mb-4 mb-md-0">
                ...
                <p class="mb-0 text-center text-lg-start" style="text-align: center !important" >Copyright © 2022-<span class="current-year"></span> | All Rights Reserved by
                    <a style="color: red !important" class="text-primary fw-normal"  target="_blank" href="https://bonikbook.com/aaconsulting/"> A & A Consulting Limited.</a>
                </p>
        </div>
